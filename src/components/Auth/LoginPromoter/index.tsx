...
type loginFormData = z.infer<typeof loginPSchema>;

const loginPSchema = z.object({
...
export default function LoginPromoter() {
    ...
    return (
            ...
            <div className="w-[90%] h-[80%] md:h-[80%] md:w-[60%] lg:h-[70%] xl:h-[70%] xl:w-[40%] gap-4 flex flex-col justify-center items-center bg-white rounded-xl overflow-auto">
                <h2 className="text-xl xl:text-3xl font-bold text-center bg-teal-500 rounded-xl p-4">Conecte-se como nosso Promoter</h2>
