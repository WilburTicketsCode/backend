...
return (
  <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center px-8 gap-4 w-full mt-8">
    <label htmlFor="Setor" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Setor do Ingresso*</label>
    <select
      id="Setor"
      className="bg-transparent border border-gray-500 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      {...register("sector")}>
      <option value="area-vip">Área vip</option>
      <option value="backstage">Backstage</option>
      <option value="camarote">Camarote</option>
    </select>
    <label htmlFor="perfil" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Perfil do Ingresso*</label>
    <select
      id="perfil"
      className="bg-transparent border border-gray-500 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      {...register("profile")}>
