...
export default function Footer() {
    return (
      <footer className="mx-auto max-w-[1920px] px-6 bg-gray-100">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 border-b py-12 text-gray-600 transition-colors duration-150 bg-gray-100">
        ...
        <div className="py-12 flex flex-col md:flex-row justify-center items-center space-y-4 bg-gray-100">
          <div>
