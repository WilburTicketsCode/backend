...
async function main() {
  ...
  const evento5 = await prisma.evento.create({
    data: {
      ...
      descricao: "O Festival de Verão Salvador é o lugar onde a alegria encontra a música. Desfrute de dias ensolarados, praia e shows incríveis no Parque de Exposições, em Salvador. Com uma mistura de ritmos como axé, sertanejo, pagode e música eletrônica, o festival promete agitar o público com artistas renomados. Dance, cante e vibre com os maiores sucessos, criando memórias inesquecíveis em uma atmosfera festiva e contagiante.",
