...
export default function SectorProf({id, quantidade}: CartItemProps){
    ...
    const item = searchLotacao(events, id)[1]
    return(
        <div className="grid grid-cols-3 h-[30px]">
            ...
            <div className= "flex ml-1 col-auto row-auto items-center">
                <p className="flex text-left text-[14px] items-center ">R${item?.valorTotal * quantidade}</p>
            </div>
